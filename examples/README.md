...
than the original artwork's. `notes/polyalanine-validation.md` (lab record) has the
cross sections themselves against the published table, to within half a percent on
every ion series.
